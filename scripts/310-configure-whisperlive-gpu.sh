...
echo "✅ Python 3.9 installed (required for WhisperLive)"
echo ""
...
echo "✅ Virtual environment created with Python 3.9"
python --version
echo ""
...
log_info "  2. Run 315-test-whisperlive-connection.sh to test connectivity"
