...
log_info "  2. Run 040-configure-edge-security.sh to configure security groups"
log_info "  3. Run 320-update-edge-clients.sh to deploy full browser clients"
log_info "  4. Run 315-test-whisperlive-connection.sh to validate end-to-end"
echo ""
